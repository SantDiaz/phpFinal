              ...
              <div class="rd-navbar-main">
                <div class="rd-navbar-nav-wrap">
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item active" class="rd-nav-item"><a class="rd-nav-link" href="informacion.php">Informacion</a>
                    </li>
          ...
          <div class="row row-30">
            <div class="col-md-6 col-lg-4">
              <article class="box-minimal">
                <div class="unit unit-spacing-md flex-column">
                  <div class="unit-left">
                    <div class="box-minimal-icon fa-thumbs-up"></div>
                  </div>
                  <div class="unit-body">
                    <h4 class="box-minimal-title"><a href="#">Best Service</a></h4>
            ...
            <div class="col-md-6 col-lg-4">
              <article class="box-minimal">
                <div class="unit unit-spacing-md flex-column">
                  ...
                  <div class="unit-body">
                    <h4 class="box-minimal-title"><a href="#">Reputation</a></h4>
            ...
            <div class="col-md-6 col-lg-4">
              <article class="box-minimal">
                <div class="unit unit-spacing-md flex-column">
                  <div class="unit-left">
                    <div class="box-minimal-icon fa-lock"></div>
                  </div>
                  <div class="unit-body">
                    <h4 class="box-minimal-title"><a href="#">Safety &amp; Security</a></h4>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-10 col-xl-8">
              ...
              <figure class="figure-light"><img src="images/image-10-370x217.jpg" alt="" width="370" height="108"/>
                <figcaption>
                  <p>Our Team</p>
                </figcaption>
              </figure>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-10 col-xl-8">
              <h3>Image Left</h3>
              <div class="row row-30">
                <div class="col-md-6"><img src="images/image-10-370x217.jpg" alt="" width="370" height="108"/>
                </div>
                <div class="col-md-6">
                  <p>Welcome to our wonderful world. We sincerely hope that each and every user entering our website will find exactly what he/she is looking for. With advanced features of activating account and new login widgets, you will definitely have a great experience of using our web page.</p>
                </div>
